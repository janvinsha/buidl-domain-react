...
const App = () => {
    ...
    try {
      if (web3Modal.cachedProvider) {
        ...
        if (receipt.status === 1) {
          ...
          alert(
            `Domain minted! view on Polygon: https://mumbai.polygonscan.com/tx/${tx.hash} or view on OpenSea: https://testnets.opensea.io/assets/mumbai/${CONTRACT_ADDRESS}/${tx.hash}`
          );
  ...
  const checkIfWalletIsConnected = async () => {
    if (web3Modal.cachedProvider) {
      ...
      console.log("CHECKONG THE NETWORK", networks[chainId]);
        ...
        <div className="header-container">
          <header>
            ...
            <div className="right">
              ...
              />
              {currentAccount ? (
                <p onClick={disconnectWallet} as="button">
                  {" "}
